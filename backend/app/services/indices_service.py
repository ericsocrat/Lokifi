...
class IndicesService:
    ...
    def _get_fallback_indices(self, limit: int) -> List[Dict]:
        ...
        """
        fallback = [
            {"id": "SPX", "symbol": "SPX", "name": "S&P 500", "type": "indices", "current_price": 5751.13, "price_change_percentage_24h": 0.50, "provider": "fallback"},
            {"id": "DJI", "symbol": "DJI", "name": "Dow Jones Industrial Average", "type": "indices", "current_price": 42352.75, "price_change_percentage_24h": 0.81, "provider": "fallback"},
            {"id": "IXIC", "symbol": "IXIC", "name": "NASDAQ Composite", "type": "indices", "current_price": 18137.85, "price_change_percentage_24h": 0.28, "provider": "fallback"},
            {"id": "RUT", "symbol": "RUT", "name": "Russell 2000", "type": "indices", "current_price": 2209.24, "price_change_percentage_24h": 0.56, "provider": "fallback"},
            {"id": "VIX", "symbol": "VIX", "name": "CBOE Volatility Index", "type": "indices", "current_price": 18.45, "price_change_percentage_24h": -6.25, "provider": "fallback"},
            {"id": "FTSE", "symbol": "FTSE", "name": "FTSE 100", "type": "indices", "current_price": 8272.46, "price_change_percentage_24h": 0.55, "provider": "fallback"},
            {"id": "N225", "symbol": "N225", "name": "Nikkei 225", "type": "indices", "current_price": 38920.26, "price_change_percentage_24h": 0.61, "provider": "fallback"},
            {"id": "DAX", "symbol": "DAX", "name": "DAX", "type": "indices", "current_price": 19189.48, "price_change_percentage_24h": 0.47, "provider": "fallback"},
            {"id": "HSI", "symbol": "HSI", "name": "Hang Seng Index", "type": "indices", "current_price": 22640.06, "price_change_percentage_24h": 1.40, "provider": "fallback"},
            {"id": "STOXX50E", "symbol": "STOXX50E", "name": "Euro Stoxx 50", "type": "indices", "current_price": 4912.34, "price_change_percentage_24h": 0.48, "provider": "fallback"},
            {"id": "CAC40", "symbol": "CAC40", "name": "CAC 40", "type": "indices", "current_price": 7512.89, "price_change_percentage_24h": 0.52, "provider": "fallback"},
            {"id": "IBEX35", "symbol": "IBEX35", "name": "IBEX 35", "type": "indices", "current_price": 11634.20, "price_change_percentage_24h": 0.65, "provider": "fallback"},
            {"id": "SMI", "symbol": "SMI", "name": "Swiss Market Index", "type": "indices", "current_price": 12089.45, "price_change_percentage_24h": 0.38, "provider": "fallback"},
            {"id": "TSX", "symbol": "TSX", "name": "S&P/TSX Composite", "type": "indices", "current_price": 23567.89, "price_change_percentage_24h": 0.44, "provider": "fallback"},
            {"id": "ASX200", "symbol": "ASX200", "name": "ASX 200", "type": "indices", "current_price": 8234.56, "price_change_percentage_24h": 0.71, "provider": "fallback"},
        ]
