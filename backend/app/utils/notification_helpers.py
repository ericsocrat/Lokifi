...
try:
    ...
    spec = importlib.util.spec_from_file_location("setup_j6_integration", scripts_dir / "setup_j6_integration.py")
    if spec and spec.loader:
        ...
        raise ImportError(f"Could not load setup_j6_integration from {scripts_dir}") from e
