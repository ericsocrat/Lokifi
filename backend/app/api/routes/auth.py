...
def register(payload: RegisterPayload):
    with get_session() as db:
        ...
        u = User(handle=payload.handle, password_hash=pw_hash, avatar_url=payload.avatar_url, bio=payload.bio)
        db.add(u)
        db.flush()
...
def me(authorization: Optional[str] = Header(None)):
    ...
    with get_session() as db:
        ...
        return {"handle": u.handle, "avatar_url": u.avatar_url, "bio": u.bio, "created_at": u.created_at.isoformat()}
