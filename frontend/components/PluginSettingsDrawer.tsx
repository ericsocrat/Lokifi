      ...
      <div className="space-y-4 text-sm">
        <section>
          ...
          <label className="flex items-center gap-2 mb-2">
            ...
            <select value={s.channelWidthMode as any} onChange={e=> pluginSettingsStore.set("channelWidthMode", e.target.value as any)} className="ml-auto px-2 py-1 bg-neutral-950 border border-neutral-800 rounded-lg">
          ...
          <label className="flex items-center gap-2">
            ...
            <input
              ...
              onChange={(e)=> pluginSettingsStore.set("channelDefaultWidthPct", parseFloat(e.target.value || "0"))}
          ...
          {s.fibPreset === "Custom" && (
            <div className="mt-2">
              <input
                ...
                onChange={(e)=> {
                  const vals = e.target.value.split(",").map(x=> parseFloat(x.trim())).filter(n=> !Number.isNaN(n));
              ...
              />
              <div className="text-[11px] opacity-70 mt-1">Tip: include 0 and 1 to see the base box.</div>
            </div>
          )}
        </section>
