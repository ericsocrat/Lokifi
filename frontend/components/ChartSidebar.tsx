...
const PLUGINS = [
  ...
  { id: "parallel-channel-3pt", label: "Channel 3pt", icon: <Waves size={16} />, shortcut: "Shift+C" },
              ...
              {TOOLS.map(t => (
                ...
                >
                  ...
                  <div>
                    <div>{t.label}</div>
                    {t.shortcut && (
                      <div className="text-[10px] opacity-60">{t.shortcut}</div>
                    )}
                  </div>
                </button>
              ))}
                ...
                {PLUGINS.map(p => (
                  ...
                  >
                    ...
                    <div>
                      <div>{p.label}</div>
                      {p.shortcut && (
                        <div className="text-[10px] opacity-60">{p.shortcut}</div>
                      )}
                    </div>
                  </button>
                ))}
