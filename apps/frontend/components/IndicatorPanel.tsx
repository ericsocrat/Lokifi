...
export default function IndicatorPanel() {
  ...
  const toggle = (k: keyof IndicatorFlags) => () => indicatorStore.toggle(k);
  return (
    <div className="rounded-2xl border border-neutral-800 p-3">
      ...
      <div className="grid grid-cols-2 gap-2 text-sm">
        ...
        <label className="flex items-center gap-2">
          <input type="checkbox" checked={s.bband} onChange={toggle('bband')} /> Bollinger Bands
          (20,2)
        </label>
        <label className="flex items-center gap-2">
        ...
        <label className="flex items-center gap-2">
          <input type="checkbox" checked={s.bbFill} onChange={toggle('bbFill')} /> BB fill (shade
          between bands)
        </label>
        <label className="flex items-center gap-2">
          <input type="checkbox" checked={s.vwap} onChange={toggle('vwap')} /> VWAP
