...
import { listVersions, loadCurrent, saveCurrent, saveVersion, type PersistSnapshot } from '@/lib/utils/persist';
import type { Drawing } from '@/lib/utils/drawings';

describe('persist', () => {
  const mockDrawings: Drawing[] = [
    { id: 'draw-1', type: 'trendline' as const, points: [{ x: 0, y: 0, price: 100, time: 1000 }], style: { color: '#ff0000', lineWidth: 2 } },
    { id: 'draw-2', type: 'hline' as const, points: [{ x: 0, y: 50, price: 150, time: 2000 }], style: { color: '#00ff00', lineWidth: 1 } },
  ];
