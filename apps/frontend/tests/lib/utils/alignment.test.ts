  ...
  describe('align', () => {
    describe('left alignment', () => {
      it('should align selected drawings to leftmost edge', () => {
        const drawings: Drawing[] = [
          mockDrawing('d1', [{ x: 10, y: 20 }, { x: 30, y: 40 }]),
          mockDrawing('d2', [{ x: 50, y: 20 }, { x: 70, y: 40 }]),
          mockDrawing('d3', [{ x: 100, y: 20 }, { x: 120, y: 40 }]),
        ];
    ...
    describe('right alignment', () => {
      ...
      it('should preserve y coordinates when aligning right', () => {
        const drawings: Drawing[] = [
          mockDrawing('d1', [{ x: 10, y: 100 }, { x: 30, y: 200 }]),
          mockDrawing('d2', [{ x: 50, y: 300 }, { x: 70, y: 400 }]),
        ];
        const ids = new Set(['d1', 'd2']);
    ...
    describe('top alignment', () => {
      it('should align selected drawings to topmost edge', () => {
        const drawings: Drawing[] = [
          mockDrawing('d1', [{ x: 20, y: 10 }, { x: 40, y: 30 }]),
          mockDrawing('d2', [{ x: 20, y: 50 }, { x: 40, y: 70 }]),
          mockDrawing('d3', [{ x: 20, y: 100 }, { x: 40, y: 120 }]),
        ];
        const ids = new Set(['d1', 'd2', 'd3']);
      ...
      it('should preserve x coordinates when aligning top', () => {
        const drawings: Drawing[] = [
          mockDrawing('d1', [{ x: 100, y: 10 }, { x: 200, y: 30 }]),
          mockDrawing('d2', [{ x: 300, y: 50 }, { x: 400, y: 70 }]),
        ];
        const ids = new Set(['d1', 'd2']);
    ...
    describe('bottom alignment', () => {
      ...
      it('should handle negative coordinates', () => {
        const drawings: Drawing[] = [
          mockDrawing('d1', [{ x: 0, y: -10 }, { x: 10, y: 0 }]),
          mockDrawing('d2', [{ x: 0, y: -50 }, { x: 10, y: -40 }]),
        ];
        const ids = new Set(['d1', 'd2']);
    ...
    describe('multi-point drawings', () => {
      ...
      it('should maintain point order', () => {
        const drawings: Drawing[] = [
          mockDrawing('d1', [{ x: 10, y: 20 }, { x: 30, y: 40 }]),
          mockDrawing('d2', [{ x: 50, y: 60 }, { x: 70, y: 80 }]),
        ];
        const ids = new Set(['d1', 'd2']);
    ...
    describe('edge cases', () => {
      ...
      it('should handle drawings already aligned', () => {
        const drawings: Drawing[] = [
          mockDrawing('d1', [{ x: 10, y: 20 }, { x: 30, y: 40 }]),
          mockDrawing('d2', [{ x: 10, y: 60 }, { x: 30, y: 80 }]),
        ];
        const ids = new Set(['d1', 'd2']);
  ...
  describe('distribute', () => {
    describe('horizontal distribution', () => {
      it('should evenly distribute 3 drawings horizontally', () => {
        const drawings: Drawing[] = [
          mockDrawing('d1', [{ x: 0, y: 0 }, { x: 10, y: 10 }]),
          mockDrawing('d2', [{ x: 20, y: 0 }, { x: 30, y: 10 }]),
          mockDrawing('d3', [{ x: 100, y: 0 }, { x: 110, y: 10 }]),
        ];
        const ids = new Set(['d1', 'd2', 'd3']);
    ...
    describe('vertical distribution', () => {
      it('should evenly distribute 3 drawings vertically', () => {
        const drawings: Drawing[] = [
          mockDrawing('d1', [{ x: 0, y: 0 }, { x: 10, y: 10 }]),
          mockDrawing('d2', [{ x: 0, y: 20 }, { x: 10, y: 30 }]),
          mockDrawing('d3', [{ x: 0, y: 100 }, { x: 10, y: 110 }]),
        ];
        const ids = new Set(['d1', 'd2', 'd3']);
    ...
    describe('edge cases', () => {
      ...
      it('should handle multi-point drawings', () => {
        const drawings: Drawing[] = [
          mockDrawing('d1', [{ x: 0, y: 0 }, { x: 10, y: 10 }, { x: 20, y: 20 }]),
          mockDrawing('d2', [{ x: 30, y: 0 }, { x: 40, y: 10 }]),
          mockDrawing('d3', [{ x: 100, y: 0 }, { x: 110, y: 10 }]),
        ];
        const ids = new Set(['d1', 'd2', 'd3']);
  ...
  describe('integration - combined operations', () => {
    it('should align then distribute correctly', () => {
      let drawings: Drawing[] = [
        mockDrawing('d1', [{ x: 10, y: 0 }, { x: 20, y: 10 }]),
        mockDrawing('d2', [{ x: 50, y: 0 }, { x: 60, y: 10 }]),
        mockDrawing('d3', [{ x: 100, y: 0 }, { x: 110, y: 10 }]),
      ];
      const ids = new Set(['d1', 'd2', 'd3']);
