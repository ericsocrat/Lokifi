...
describe('DrawingStore', () => {
  ...
  it('should initialize with default state', () => {
    const { activeTool, isDrawing, objects, selectedObjectId } = useDrawingStore.getState();
  ...
  it('should toggle drawing settings', () => {
    const { toggleSnapToGrid, toggleSnapToPrice, toggleMagnetMode } = useDrawingStore.getState();
