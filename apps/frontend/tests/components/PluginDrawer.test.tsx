...
describe('PluginDrawer', () => {
  ...
  describe('Configuration Updates', () => {
    ...
    it('should save to storage when input changes', () => {
      ...
      expect(mockSaveJSON).toHaveBeenCalledWith('lokifi-plugin-cfg', expect.objectContaining({
  ...
  describe('Export Functionality', () => {
    ...
    it('should create JSON blob when export is clicked', () => {
      ...
      expect(createdBlobContent).toBe(JSON.stringify({ 'plugin-1': { apiKey: 'test-key' } }, null, 2));
    });
  ...
  describe('Button Styling', () => {
    it('should apply correct styling to Export button', () => {
      ...
      expect(exportButton).toHaveClass('px-3', 'py-2', 'rounded-2xl', 'border', 'border-neutral-700');
    });
    ...
    it('should apply correct styling to Import button', () => {
      ...
      expect(importButton).toHaveClass('px-3', 'py-2', 'rounded-2xl', 'border', 'border-neutral-700');
    });
