...
const mockSetDarkMode = vi.fn((value: boolean) => { mockDarkMode = value; });
const mockSetCurrency = vi.fn((value: string) => { mockCurrency = value; });
...
describe('GlobalLayout', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render the Lokifi logo', () => {
      render(<GlobalLayout><div /></GlobalLayout>);
  ...
  describe('Sidebar Toggle', () => {
    it('should toggle sidebar when clicking toggle button', async () => {
      ...
      const { container } = render(<GlobalLayout><div /></GlobalLayout>);
