...
vi.mock('../../components/NotificationBell', () => ({
  NotificationBell: ({ className }: { className?: string }) => (
    <div data-testid="notification-bell" className={className}>NotificationBell</div>
  ),
}));
...
describe('Navbar', () => {
  ...
  describe('Unauthenticated State', () => {
    ...
    it('should apply correct styling to login button', () => {
      ...
      expect(loginButton).toHaveClass('bg-blue-600', 'hover:bg-blue-700', 'text-white', 'font-medium');
    });
  });
