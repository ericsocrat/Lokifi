      ...
      <div className="min-h-screen bg-neutral-950">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="text-center py-12">
            ...
            <p className="text-neutral-400 mb-6">Please log in to view your notifications.</p>
            <Link
              href="/login"
  ...
  return (
    <main className="min-h-screen bg-neutral-950" role="main" aria-label="Notifications page">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <NotificationCenter className="w-full" showHeader={false} maxHeight="calc(100vh - 200px)" />
      </div>
    </main>
  );
}
