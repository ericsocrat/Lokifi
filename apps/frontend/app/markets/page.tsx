      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
              ...
              {cryptos.map((asset: UnifiedAsset) => (
                ...
                >
                  ...
                  {asset.price_change_percentage_24h !== undefined && (
                    <div
                      className={`flex items-center gap-1 text-sm ${asset.price_change_percentage_24h >= 0 ? 'text-green-500' : 'text-red-500'}`}
                    >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white flex items-center gap-2">
                    Stocks
                    <span className="text-xs px-2 py-0.5 bg-green-500/20 text-green-500 rounded border border-green-500/30">
                      Live Data
                    </span>
                  </h2>
        ...
        {data && (
          <div className="flex items-center justify-center gap-2 text-xs text-neutral-500">
            <div
              className={`w-2 h-2 rounded-full ${data.cached ? 'bg-green-500' : 'bg-blue-500'}`}
            />
