...
async def log_rate_limit_exceeded(
    client_ip: str, endpoint: str | None = None, limit_type: str | None = None
):
...
async def log_suspicious_request(
    client_ip: str, endpoint: str, pattern: str, user_agent: str | None = None
):
...
async def log_input_validation_failure(
    client_ip: str, field: str, value_type: str, endpoint: str | None = None
):
