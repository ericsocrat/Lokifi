...
class UnifiedAssetService:
    ...
    def _get_mock_stocks(self, limit: int) -> list[dict]:
        ...
        stocks = [
            ...
            {"id": "MSFT", "symbol": "MSFT", "name": "Microsoft Corporation", "type": "stocks", "current_price": 378.91, "price_change_percentage_24h": 1.45, "market_cap": 2820000000000, "volume_24h": 21000000, "rank": 2},
            {"id": "GOOGL", "symbol": "GOOGL", "name": "Alphabet Inc.", "type": "stocks", "current_price": 141.53, "price_change_percentage_24h": -0.61, "market_cap": 1780000000000, "volume_24h": 18000000, "rank": 3},
            {"id": "AMZN", "symbol": "AMZN", "name": "Amazon.com Inc.", "type": "stocks", "current_price": 178.25, "price_change_percentage_24h": 1.78, "market_cap": 1850000000000, "volume_24h": 45000000, "rank": 4},
            {"id": "NVDA", "symbol": "NVDA", "name": "NVIDIA Corporation", "type": "stocks", "current_price": 495.22, "price_change_percentage_24h": 2.56, "market_cap": 1220000000000, "volume_24h": 38000000, "rank": 5},
            {"id": "TSLA", "symbol": "TSLA", "name": "Tesla Inc.", "type": "stocks", "current_price": 242.84, "price_change_percentage_24h": -2.28, "market_cap": 772000000000, "volume_24h": 95000000, "rank": 6},
            {"id": "META", "symbol": "META", "name": "Meta Platforms Inc.", "type": "stocks", "current_price": 512.33, "price_change_percentage_24h": 1.77, "market_cap": 1310000000000, "volume_24h": 14000000, "rank": 7},
            {"id": "BRK.B", "symbol": "BRK.B", "name": "Berkshire Hathaway Inc.", "type": "stocks", "current_price": 438.75, "price_change_percentage_24h": 0.56, "market_cap": 952000000000, "volume_24h": 3200000, "rank": 8},
            {"id": "V", "symbol": "V", "name": "Visa Inc.", "type": "stocks", "current_price": 287.92, "price_change_percentage_24h": 0.43, "market_cap": 585000000000, "volume_24h": 5600000, "rank": 9},
            {"id": "JPM", "symbol": "JPM", "name": "JPMorgan Chase & Co.", "type": "stocks", "current_price": 201.45, "price_change_percentage_24h": -0.66, "market_cap": 583000000000, "volume_24h": 8900000, "rank": 10},
        ]
        return stocks[:limit]
    ...
    def _get_mock_indices(self) -> list[dict]:
        ...
        return [
            ...
            {"id": "DJI", "symbol": "DJI", "name": "Dow Jones Industrial Average", "type": "indices", "current_price": 42352.75, "price_change_percentage_24h": 0.81},
            {"id": "IXIC", "symbol": "IXIC", "name": "NASDAQ Composite", "type": "indices", "current_price": 18137.85, "price_change_percentage_24h": 0.28},
            {"id": "RUT", "symbol": "RUT", "name": "Russell 2000", "type": "indices", "current_price": 2209.24, "price_change_percentage_24h": 0.56},
            {"id": "VIX", "symbol": "VIX", "name": "CBOE Volatility Index", "type": "indices", "current_price": 18.45, "price_change_percentage_24h": -6.25},
            {"id": "FTSE", "symbol": "FTSE", "name": "FTSE 100", "type": "indices", "current_price": 8272.46, "price_change_percentage_24h": 0.55},
            {"id": "N225", "symbol": "N225", "name": "Nikkei 225", "type": "indices", "current_price": 38920.26, "price_change_percentage_24h": 0.61},
            {"id": "DAX", "symbol": "DAX", "name": "DAX", "type": "indices", "current_price": 19189.48, "price_change_percentage_24h": 0.47},
            {"id": "HSI", "symbol": "HSI", "name": "Hang Seng Index", "type": "indices", "current_price": 22640.06, "price_change_percentage_24h": 1.40},
    ...
    def _get_mock_forex(self, limit: int) -> list[dict]:
        ...
        forex = [
            ...
            {"id": "GBPUSD", "symbol": "GBP/USD", "name": "British Pound / US Dollar", "type": "forex", "current_price": 1.3124, "price_change_percentage_24h": 0.26},
            {"id": "USDJPY", "symbol": "USD/JPY", "name": "US Dollar / Japanese Yen", "type": "forex", "current_price": 148.92, "price_change_percentage_24h": -0.30},
            {"id": "AUDUSD", "symbol": "AUD/USD", "name": "Australian Dollar / US Dollar", "type": "forex", "current_price": 0.6734, "price_change_percentage_24h": 0.18},
            {"id": "USDCAD", "symbol": "USD/CAD", "name": "US Dollar / Canadian Dollar", "type": "forex", "current_price": 1.3589, "price_change_percentage_24h": -0.17},
            {"id": "USDCHF", "symbol": "USD/CHF", "name": "US Dollar / Swiss Franc", "type": "forex", "current_price": 0.8567, "price_change_percentage_24h": -0.13},
            {"id": "NZDUSD", "symbol": "NZD/USD", "name": "New Zealand Dollar / US Dollar", "type": "forex", "current_price": 0.6145, "price_change_percentage_24h": 0.13},
            {"id": "EURGBP", "symbol": "EUR/GBP", "name": "Euro / British Pound", "type": "forex", "current_price": 0.8342, "price_change_percentage_24h": -0.06},
            {"id": "EURJPY", "symbol": "EUR/JPY", "name": "Euro / Japanese Yen", "type": "forex", "current_price": 162.98, "price_change_percentage_24h": 0.21},
            {"id": "GBPJPY", "symbol": "GBP/JPY", "name": "British Pound / Japanese Yen", "type": "forex", "current_price": 195.45, "price_change_percentage_24h": 0.34},
        ]
        return forex[:limit]
