"""
Tests for app.routers.ai_websocket
...
class TestaiwebsocketIntegration:
    """Integration tests for ai_websocket"""
...
class TestaiwebsocketEdgeCases:
...
@pytest.mark.slow
class TestaiwebsocketPerformance:
