"""
Tests for app.routers.websocket_prices
...
class Testwebsocketprices:
    """Test suite for websocket_prices"""
...
class TestwebsocketpricesIntegration:
    """Integration tests for websocket_prices"""
...
class TestwebsocketpricesEdgeCases:
...
@pytest.mark.slow
class TestwebsocketpricesPerformance:
