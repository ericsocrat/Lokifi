...
class Testadminmessaging:
    """Test suite for admin_messaging"""
...
class TestadminmessagingIntegration:
    """Integration tests for admin_messaging"""
...
class TestadminmessagingEdgeCases:
...
@pytest.mark.slow
class TestadminmessagingPerformance:
