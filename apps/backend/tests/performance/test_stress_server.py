...
async def health_check():
    ...
    return {"status": "healthy", "timestamp": time.time(), "uptime": "running"}
...
async def cpu_intensive_task():
    ...
    return {"task": "cpu_intensive", "result": result, "duration_seconds": duration}
...
async def memory_intensive_task():
    ...
    return {"task": "memory_intensive", "data_points": len(data), "sample": data[:10]}
