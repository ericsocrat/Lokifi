"""
Tests for app.schemas.ai_schemas
...
class TestaischemasIntegration:
    """Integration tests for ai_schemas"""
...
@pytest.mark.slow
class TestaischemasPerformance:
