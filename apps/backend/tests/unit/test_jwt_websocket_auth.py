"""
Tests for app.websockets.jwt_websocket_auth
...
class Testjwtwebsocketauth:
    """Test suite for jwt_websocket_auth"""
...
class TestjwtwebsocketauthIntegration:
    """Integration tests for jwt_websocket_auth"""
...
class TestjwtwebsocketauthEdgeCases:
...
@pytest.mark.slow
class TestjwtwebsocketauthPerformance:
