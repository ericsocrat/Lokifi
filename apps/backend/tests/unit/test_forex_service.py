...
class TestForexServiceInit:
    ...
    def test_init_without_redis(self):
        ...
        assert len(service.currency_pairs) == 50  # Total currency pairs configured (actual implementation)
...
class TestGetForexPairs:
    ...
    async def test_get_forex_pairs_continues_on_individual_pair_error(self):
        ...
        with patch("httpx.AsyncClient") as MockClient:
            ...
            second_response = create_mock_response(json_data={
                "result": "success",
                "conversion_rates": {"GBP": 0.79}
            })
