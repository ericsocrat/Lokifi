"""
Tests for app.websockets.advanced_websocket_manager
...
class Testadvancedwebsocketmanager:
    """Test suite for advanced_websocket_manager"""
...
class TestadvancedwebsocketmanagerIntegration:
    """Integration tests for advanced_websocket_manager"""
...
class TestadvancedwebsocketmanagerEdgeCases:
...
@pytest.mark.slow
class TestadvancedwebsocketmanagerPerformance:
