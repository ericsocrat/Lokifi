...
try:
    from app.services.crypto_data_service import *
...
class Testcryptodataservice:
    ""Test suite for crypto_data_service""
...
class TestcryptodataserviceIntegration:
    ""Integration tests for crypto_data_service""
...
@pytest.mark.slow
class TestcryptodataservicePerformance:
