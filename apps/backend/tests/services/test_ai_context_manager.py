"""
Tests for app.services.ai_context_manager
...
class Testaicontextmanager:
    ""Test suite for ai_context_manager""
...
class TestaicontextmanagerIntegration:
    ""Integration tests for ai_context_manager""
...
class TestaicontextmanagerEdgeCases:
...
@pytest.mark.slow
class TestaicontextmanagerPerformance:
