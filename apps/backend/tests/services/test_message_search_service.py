"""
Tests for app.services.message_search_service
...
class Testmessagesearchservice:
    """Test suite for message_search_service"""
...
class TestmessagesearchserviceIntegration:
    """Integration tests for message_search_service"""
...
class TestmessagesearchserviceEdgeCases:
...
@pytest.mark.slow
class TestmessagesearchservicePerformance:
