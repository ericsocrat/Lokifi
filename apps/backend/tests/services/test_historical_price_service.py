...
class Testhistoricalpriceservice:
    """Test suite for historical_price_service"""
...
class TesthistoricalpriceserviceIntegration:
    """Integration tests for historical_price_service"""
...
class TesthistoricalpriceserviceEdgeCases:
...
@pytest.mark.slow
class TesthistoricalpriceservicePerformance:
