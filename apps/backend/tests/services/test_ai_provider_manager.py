"""
Tests for app.services.ai_provider_manager
...
class Testaiprovidermanager:
    """Test suite for ai_provider_manager"""
...
class TestaiprovidermanagerIntegration:
    """Integration tests for ai_provider_manager"""
...
class TestaiprovidermanagerEdgeCases:
...
@pytest.mark.slow
class TestaiprovidermanagerPerformance:
