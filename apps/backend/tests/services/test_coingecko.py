"""
Tests for app.services.providers.coingecko
...
try:
    from app.services.providers.coingecko import *
...
@pytest.mark.slow
class TestcoingeckoPerformance:
