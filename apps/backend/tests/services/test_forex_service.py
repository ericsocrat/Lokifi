"""
Tests for app.services.forex_service
...
class TestforexserviceIntegration:
    """Integration tests for forex_service"""
...
class TestforexserviceEdgeCases:
...
@pytest.mark.slow
class TestforexservicePerformance:
