"""
Tests for app.services.crypto_data
...
class TestcryptodataIntegration:
    ""Integration tests for crypto_data""
...
@pytest.mark.slow
class TestcryptodataPerformance:
