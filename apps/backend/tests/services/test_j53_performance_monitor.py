...
class Testj53performancemonitor:
    """Test suite for j53_performance_monitor"""
...
class Testj53performancemonitorIntegration:
    """Integration tests for j53_performance_monitor"""
...
class Testj53performancemonitorEdgeCases:
...
@pytest.mark.slow
class Testj53performancemonitorPerformance:
