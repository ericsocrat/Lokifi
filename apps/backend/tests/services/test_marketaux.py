"""
Tests for app.services.providers.marketaux
...
try:
    from app.services.providers.marketaux import *
...
class TestmarketauxIntegration:
    """Integration tests for marketaux"""
...
@pytest.mark.slow
class TestmarketauxPerformance:
