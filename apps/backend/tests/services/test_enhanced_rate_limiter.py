"""
Tests for app.services.enhanced_rate_limiter
...
class Testenhancedratelimiter:
    """Test suite for enhanced_rate_limiter"""
...
class TestenhancedratelimiterIntegration:
    """Integration tests for enhanced_rate_limiter"""
...
class TestenhancedratelimiterEdgeCases:
...
@pytest.mark.slow
class TestenhancedratelimiterPerformance:
