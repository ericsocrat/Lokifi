...
from tests.fixtures.mock_auth_service import (
    mock_db_session,
...
class TestAuthServiceRegistration:
    ...
    @pytest.mark.asyncio
    async def test_register_user_success(self, auth_service, mock_db_session, sample_user_register_request):
        ...
        with patch('app.services.auth_service.validate_email', return_value=True), \
    ...
    @pytest.mark.asyncio
    async def test_register_user_duplicate_email(self, auth_service, mock_db_session, sample_user_register_request, mock_user):
    ...
    @pytest.mark.asyncio
    async def test_register_user_duplicate_username(self, auth_service, mock_db_session, sample_user_register_request, mock_profile):
...
class TestAuthServiceLogin:
    ...
    @pytest.mark.asyncio
    async def test_login_user_success(self, auth_service, mock_db_session, sample_user_login_request, mock_user, mock_profile):
    ...
    @pytest.mark.asyncio
    async def test_login_user_not_found(self, auth_service, mock_db_session, sample_user_login_request):
    ...
    @pytest.mark.asyncio
    async def test_login_user_wrong_password(self, auth_service, mock_db_session, sample_user_login_request, mock_user, mock_profile):
    ...
    @pytest.mark.asyncio
    async def test_login_user_inactive_account(self, auth_service, mock_db_session, sample_user_login_request, mock_user, mock_profile):
        ...
        with patch('app.services.auth_service.verify_password', return_value=True):
            ...
            assert exc_info.value.status_code == status.HTTP_403_FORBIDDEN or \
                   exc_info.value.status_code == status.HTTP_401_UNAUTHORIZED

    @pytest.mark.asyncio
    async def test_login_user_no_password_hash(self, auth_service, mock_db_session, sample_user_login_request, mock_user, mock_profile):
...
class TestAuthServiceIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_registration_flow(self, auth_service, mock_db_session, sample_user_register_request):
    ...
    @pytest.mark.asyncio
    async def test_login_after_registration(self, mock_db_session, sample_user_register_request, sample_user_login_request):
...
class TestAuthServiceEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_database_error_during_registration(self, auth_service, mock_db_session, sample_user_register_request):
    ...
    @pytest.mark.asyncio
    async def test_database_error_during_login(self, auth_service, mock_db_session, sample_user_login_request):
    ...
    @pytest.mark.asyncio
    async def test_token_generation_failure(self, auth_service, mock_db_session, sample_user_register_request):
        ...
        with patch('app.services.auth_service.validate_email', return_value=True), \
             patch('app.services.auth_service.validate_password_strength', return_value=True), \
             patch('app.services.auth_service.hash_password', return_value="hashed"), \
             patch('app.services.auth_service.create_access_token', side_effect=Exception("Token error")):
