...
function AssetDetailContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 dark:from-gray-950 dark:via-gray-950 dark:to-gray-950">
      {/* Premium Header with Gradient Background */}
      <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 shadow-2xl">
        ...
        <div className="relative z-10 max-w-[1800px] mx-auto px-6 md:px-8 py-8">
          {/* Navigation Bar */}
          <div className="flex items-center justify-between mb-8">
            <button
              onClick={() => router.back()}
              className="flex items-center gap-2 px-4 py-2.5 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-xl transition-all text-white font-medium group"
            >
            ...
            <div className="flex items-center gap-3">
              <button className="p-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-xl transition-all hover:scale-105">
          ...
          <div className="flex items-start justify-between gap-6 flex-wrap">
            <div className="flex items-start gap-5">
              ...
              <div className="relative">
                <div className="w-20 h-20 bg-gradient-to-br from-white to-gray-100 rounded-2xl shadow-xl flex items-center justify-center transform hover:rotate-6 transition-transform">
              ...
              <div>
                <div className="flex items-center gap-3 mb-2 flex-wrap">
                  ...
                  <span className="px-3 py-1.5 text-sm font-bold rounded-xl bg-white/20 backdrop-blur-sm text-white">
                    {symbol}
                  </span>
                  <span className={`px-3 py-1.5 text-xs font-bold rounded-xl backdrop-blur-sm ${
                    asset.type === 'crypto' 
                      ? 'bg-purple-400/30 text-white border border-purple-300/30' 
                ...
                <div className="flex items-baseline gap-4 flex-wrap mb-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className={`px-4 py-2.5 rounded-xl text-2xl font-black backdrop-blur-sm ${
                      isPositive 
                        ? 'bg-green-500/30 border border-green-400/30' 
                        : 'bg-red-500/30 border border-red-400/30'
                    } text-white`}>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button className="px-5 py-3 bg-white/90 hover:bg-white text-gray-700 font-bold rounded-xl transition-all flex items-center gap-2 hover:scale-105 shadow-lg">
              ...
              <button
                ...
                className="px-6 py-3 bg-white hover:bg-gray-50 text-purple-600 font-bold rounded-xl transition-all flex items-center gap-2 hover:scale-105 shadow-xl relative overflow-hidden group"
              >
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-8 py-8">
        ...
        <div 
          className="bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 rounded-2xl p-6 mb-8 relative overflow-hidden group cursor-pointer hover:shadow-2xl hover:scale-[1.02] transition-all"
          onClick={() => router.push(`/chart?symbol=${symbol}`)}
        >
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <h3 className="text-white font-black text-2xl mb-2 flex items-center gap-2">
                  ...
                  Advanced Technical Analysis Available
                </h3>
                <p className="text-white/95 text-base font-medium">
                  Access professional trading tools, 100+ indicators, and real-time data in SuperChart
                </p>
              </div>
            </div>
            <button className="px-8 py-4 bg-white hover:bg-gray-50 text-purple-600 font-black rounded-xl transition-all flex items-center gap-3 hover:scale-105 shadow-2xl text-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-2xl p-8 shadow-xl">
              ...
              <div className="relative h-[450px] bg-gradient-to-br from-gray-50 to-blue-50/30 dark:from-gray-950 dark:to-blue-950/30 rounded-xl p-6 border border-gray-200 dark:border-gray-800">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-xl">
              <h3 className="text-xl font-black text-gray-900 dark:text-white mb-5 flex items-center gap-3">
              ...
              <div className="space-y-3">
                <button
                  onClick={() => router.push(`/chart?symbol=${symbol}`)}
                  className="w-full px-5 py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-black rounded-xl transition-all flex items-center justify-center gap-3 hover:scale-105 shadow-lg text-base"
                >
                  <Maximize2 className="w-5 h-5" />
                  Open SuperChart
                </button>
                <button
                  onClick={() => setShowAddModal(true)}
                  className="w-full px-5 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all flex items-center justify-center gap-3 hover:scale-105"
                >
                  <Plus className="w-5 h-5" />
                  Add to Portfolio
                </button>
